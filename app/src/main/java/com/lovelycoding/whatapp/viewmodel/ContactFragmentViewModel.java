...
public class ContactFragmentViewModel extends ViewModel {
    ...
    public void userList() {
        ...
        contactDatabaseRef= FirebaseDatabase.getInstance().getReference().child("contacts").child(currentUserId);

        mutableLiveData= Repository.getRepositoryInstance().getContactList(contactDatabaseRef,currentUserId);
